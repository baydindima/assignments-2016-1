...
public class ThreadPoolImplTest {
    ...
    @Test
    public void thanApplyTest() throws LightExecutionException, InterruptedException {
        ThreadPool threadPool = new ThreadPoolImpl(1);
        LightFuture<Integer> future = threadPool.submit(() -> 10);
    ...
    @Test
    public void countOffThreadsTest() throws LightExecutionException, InterruptedException {
